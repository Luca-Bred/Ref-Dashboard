...
def fetch_events():
    ...
    print('Rufe Apps Script auf: ' + url)
...
def update_html(events):
    if not os.path.exists(HTML_FILE):
        raise SystemExit('HTML-Datei nicht gefunden: ' + HTML_FILE)
